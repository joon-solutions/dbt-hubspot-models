{{ config(enabled=var('salesforce__task_enabled', False) and var('outreach_opportunity', False) and var('salesforce__opportunity_enabled', False) and var('outreach_task', False)) }}
