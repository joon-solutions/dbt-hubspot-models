{% macro get_marketo_activity_change_data_value_columns() %}
...
{% set columns = [
    ...
    {"name": "id", "datatype": dbt_utils.type_string(), "alias": "activity_id"},
    {"name": "lead_id", "datatype": dbt_utils.type_int()},
    {"name": "modifying_user", "datatype": dbt_utils.type_string(), "alias": "modifying_user_id"},
    ...
    {"name": "reason", "datatype": dbt_utils.type_string(), "alias": "change_reason"},
    {"name": "request_id", "datatype": dbt_utils.type_string()},
    {"name": "source", "datatype": dbt_utils.type_string(), "alias": "change_source"}
] %}
...
{% macro get_marketo_activity_click_email_columns() %}
...
{% set columns = [
    ...
    {"name": "device", "datatype": dbt_utils.type_string(), "alias": "click_device"},
    {"name": "email_template_id", "datatype": dbt_utils.type_int()},
    {"name": "id", "datatype": dbt_utils.type_string(), "alias": "activity_id"},
    {"name": "is_mobile_device", "datatype": "boolean"},
    {"name": "lead_id", "datatype": dbt_utils.type_int()},
    {"name": "link", "datatype": dbt_utils.type_string(), "alias": "click_link_url"},
    {"name": "link_id", "datatype": dbt_utils.type_string()},
    {"name": "platform", "datatype": dbt_utils.type_string(), "alias": "user_platform"},
    {"name": "primary_attribute_value", "datatype": dbt_utils.type_string()},
    {"name": "primary_attribute_value_id", "datatype": dbt_utils.type_int()},
...
{% macro get_marketo_activity_delete_lead_columns() %}

{% set columns = [
    {"name": "_fivetran_synced", "datatype": dbt_utils.type_timestamp()},
    {"name": "activity_date", "datatype": dbt_utils.type_timestamp()},
    {"name": "activity_type_id", "datatype": dbt_utils.type_int()},
    {"name": "campaign", "datatype": dbt_utils.type_string(), "alias": "campaign_name"},
    {"name": "campaign_id", "datatype": dbt_utils.type_int()},
    {"name": "id", "datatype": dbt_utils.type_string(), "alias": "activity_id"},
    {"name": "lead_id", "datatype": dbt_utils.type_int()},
    {"name": "primary_attribute_value", "datatype": dbt_utils.type_string()},
...
{% macro get_marketo_activity_email_bounced_columns() %}
...
{% set columns = [
    ...
    {"name": "campaign_id", "datatype": dbt_utils.type_int()},
    {"name": "campaign_run_id", "datatype": dbt_utils.type_int()},
    {"name": "category", "datatype": dbt_utils.type_int(), "alias": "bounce_category"},
    {"name": "choice_number", "datatype": dbt_utils.type_int()},
    ...
    {"name": "primary_attribute_value_id", "datatype": dbt_utils.type_int()},
    {"name": "step_id", "datatype": dbt_utils.type_int()},
    {"name": "subcategory", "datatype": dbt_utils.type_int(), "alias": "bounce_subcategory"},
    {"name": "test_variant", "datatype": dbt_utils.type_int()}
] %}
...
{% macro get_marketo_activity_email_delivered_columns() %}
...
{% macro get_marketo_activity_merge_leads_columns() %}
...
{% macro get_marketo_activity_open_email_columns() %}
...
{% macro get_marketo_activity_send_email_columns() %}
...
{% macro get_marketo_activity_unsubscribe_email_columns() %}
...
{% macro get_marketo_campaign_columns() %}
...
{% set columns = [
    ...
    {"name": "type", "datatype": dbt_utils.type_string(), "alias": "campaign_type"},
...
{% macro get_marketo_email_template_history_columns() %}

{% set columns = [
    {"name": "_fivetran_synced", "datatype": dbt_utils.type_timestamp()},
    {"name": "created_at", "datatype": dbt_utils.type_timestamp(), "alias": "created_timestamp"},
    {"name": "description", "datatype": dbt_utils.type_string()},
    {"name": "folder_folder_name", "datatype": dbt_utils.type_string(), "alias": "folder_name"},
    ...
    {"name": "id", "datatype": dbt_utils.type_int(), "alias": "email_template_id"},
    {"name": "name", "datatype": dbt_utils.type_string(), "alias": "email_template_name"},
    {"name": "operational", "datatype": "boolean", "alias": "is_operational"},
    {"name": "program_id", "datatype": dbt_utils.type_int()},
    {"name": "publish_to_msi", "datatype": "boolean"},
    {"name": "reply_email", "datatype": dbt_utils.type_string()},
    {"name": "status", "datatype": dbt_utils.type_string(), "alias": "email_template_status"},
    {"name": "subject", "datatype": dbt_utils.type_string(), "alias": "email_subject"},
    {"name": "template", "datatype": dbt_utils.type_int(), "alias": "parent_template_id"},
    {"name": "text_only", "datatype": "boolean", "alias": "is_text_only"},
    {"name": "updated_at", "datatype": dbt_utils.type_timestamp(), "alias": "updated_timestamp"},
    {"name": "url", "datatype": dbt_utils.type_string(), "alias": "email_template_url"},
    {"name": "version", "datatype": dbt_utils.type_int(), "alias": "version_type"},
    {"name": "web_view", "datatype": "boolean", "alias": "has_web_view_enabled"},
    {"name": "workspace", "datatype": dbt_utils.type_string(), "alias": "workspace_name"}
] %}
...
{% macro get_marketo_lead_columns() %}
...
{% macro get_marketo_lead_describe_columns() %}

{% set columns = [
    {"name": "_fivetran_synced", "datatype": dbt_utils.type_timestamp()},
    {"name": "data_type", "datatype": dbt_utils.type_string()},
    {"name": "display_name", "datatype": dbt_utils.type_string()},
    {"name": "id", "datatype": dbt_utils.type_int(), "alias": "lead_describe_id"},
    {"name": "length", "datatype": dbt_utils.type_int(), "alias": "field_max_length"},
    {"name": "restname", "datatype": dbt_utils.type_string(), "alias": "rest_name"},
    {"name": "restread_only", "datatype": "boolean", "alias": "is_rest_readonly"},
    {"name": "soapname", "datatype": dbt_utils.type_string(), "alias": "soap_name"},
    {"name": "soapread_only", "datatype": "boolean", "alias": "is_soap_readonly"}
] %}
...
{% macro get_marketo_program_columns() %}
...
{% set columns = [
    ...
    {"name": "created_at", "datatype": dbt_utils.type_timestamp(), "alias": "created_timestamp"},
    {"name": "description", "datatype": dbt_utils.type_string()},
    {"name": "end_date", "datatype": dbt_utils.type_timestamp(), "alias": "end_timestamp"},
    {"name": "id", "datatype": dbt_utils.type_int(), "alias": "program_id"},
    {"name": "name", "datatype": dbt_utils.type_string(), "alias": "program_name"},
    {"name": "sfdc_id", "datatype": dbt_utils.type_string()},
    {"name": "sfdc_name", "datatype": dbt_utils.type_string()},
    {"name": "start_date", "datatype": dbt_utils.type_timestamp(), "alias": "start_timestamp"},
    {"name": "status", "datatype": dbt_utils.type_string(), "alias": "program_status"},
    {"name": "type", "datatype": dbt_utils.type_string(), "alias": "program_type"},
    {"name": "updated_at", "datatype": dbt_utils.type_timestamp(), "alias": "updated_timestamp"},
